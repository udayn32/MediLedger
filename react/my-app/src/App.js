    ...
    return (
        <div>
            <header>
                ...
                <nav>
                    <ul>
                        {["home", "vision", "about", "team"].map((link) => (
                            <li key={link}>
                                <a
                                    href={`#${link}`}
                                    ...
                                    style={{
                                        backgroundColor: hoveredLink === link ? '#45a049' : 'transparent',
                                        color: '#fff'
                                    }}
                                >
                                    {translations[selectedLanguage][`${link}_title`] || translations[selectedLanguage][link]}
                                </a>
                            </li>
                        ))}
                        ...
                        <a
                            href="#login"
                            className="dropbtn"
                            onClick={() => window.location.href = 'farmerlogin.html'} // Redirect to farmerlogin.html
